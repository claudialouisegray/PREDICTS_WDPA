...
tiff( "R:/ecocon_d/clg32/PREDICTS/WDPA analysis/plots/06_15/simple models matchedlanduse rar rich.tif",
...
par(mar = c(9,6,4,1))
plot(1,1, 
	ylim = c(60,145), xlim = c(0.5,nrow(r.sp.plot)),
	bty = "l", 
	axes = F,
...
text(1:nrow(r.sp.plot),62, r.sp.plot$n.site, srt = 90)

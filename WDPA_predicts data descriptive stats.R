...
### do tropical PAs tend to be younger
# or, for our sites that are tropical, does the DoP tend to be less 
# need to take into account difference between PA age and start date of sampling

names(matched.landuse)

plot(DoP ~ Zone, matched.landuse)
aggregate(DoP ~ Zone, matched.landuse, mean)
aggregate(DoP ~ Zone, matched.landuse, sd)
